...
/* harmony import */ var next_auth_jwt__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(570);
...
async function middleware(req, event) {
    ...
    if (pathname.startsWith("/information/update") || pathname.startsWith("/information/address") || pathname.startsWith("/information/address/update")) {
        if (!session) {
            return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.redirect(new URL("/information", req.url));
        }
    }
